...
import { Building2, Shield, Users, Lock, Globe, Check, ArrowRight, Zap, Server, HeadphonesIcon } from 'lucide-react';
...
export function EnterpriseSection({ onContactSales }) {
  return (
        ...
        <div className="relative bg-gradient-to-br from-[var(--bg-secondary)] to-[var(--bg-primary)] border border-[var(--border-color)] rounded-3xl overflow-hidden shadow-2xl shadow-black/10">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <motion.div 
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[150px]" 
            />
          </div>
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              {/* Right - Feature Cards with enhanced visuals */}
