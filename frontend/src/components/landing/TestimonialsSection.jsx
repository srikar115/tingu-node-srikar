...
import { Star, Quote, Building2, Briefcase, Code, Palette, Video, Camera } from 'lucide-react';
...
const testimonials = [
  {
    ...
    content: 'Tingu.ai has completely transformed our creative workflow. Having all AI models in one place saves us hours every week. The quality is consistently excellent.',
    rating: 5,
    featured: true,
  },
  {
    ...
    content: 'The cost savings are incredible. We replaced 5 different AI subscriptions with just Tingu.ai. The unified billing and analytics are a game-changer.',
    rating: 5,
    featured: false,
  },
  {
    ...
    <section className="py-24 px-4 sm:px-6 bg-[var(--bg-secondary)]/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-14">
          ...
          >
            See what our customers are saying about their experience with Tingu.ai
          </motion.p>
        </div>
          ...
          {testimonials.map((testimonial, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Quote Icon with hover highlight */}
                <motion.div
                  className="mb-4"
        ...
        {/* Trusted Companies - Styled logos/badges */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
            ...
            {trustedCompanies.map((company, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-xl hover:border-[var(--border-hover)] transition-all group"
                >
