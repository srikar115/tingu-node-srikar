...
import { 
  ...
  Building2, User, CreditCard, UserPlus, Zap
} from 'lucide-react';
...
export default function WorkspaceSwitcher({ 
  ...
  const Icon = activeWorkspace ? getWorkspaceIcon(activeWorkspace) : Building2;
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-xs text-[var(--text-muted)] mt-1">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          <span className="text-cyan-400 font-medium">{(workspace.displayCredits ?? workspace.credits)?.toFixed(2) || '0.00'}</span>
                        </span>
