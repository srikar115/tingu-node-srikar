...
const getCreditSource = (options) => {
  if (!options) return null;
  
  const opts = typeof options === 'string' ? JSON.parse(options) : options;
  return opts?.creditSource || null;
};

// Credit source badge component
const CreditSourceBadge = ({ source }) => {
...
export default function GenerationCard({ generation, viewMode = 'grid', onClick }) {
