...
export function ImageSourceModal({ 
  ...
  const handleSelectProject = async (project: Project) => {
    ...
    try {
      const token = localStorage.getItem('userToken');
      const res = await fetch(`${API_BASE}/projects/${project.id}/assets`, {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-2xl w-full max-w-3xl max-h-[80vh] overflow-hidden flex flex-col"
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {activeTab === 'upload' && (
            <div className="text-center py-12">
              ...
              <p className="text-lg font-medium mb-2 text-[var(--text-primary)]">Upload an image</p>
              <p className="text-[var(--text-muted)] mb-6">Drag and drop or click to browse</p>
              <button
                onClick={onUploadClick}
                className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-medium hover:from-cyan-400 hover:to-blue-500 transition-all text-white"
              >
                Choose File
              </button>
            </div>
            ...
            <div>
              {generatedImages.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-lg font-medium mb-2 text-[var(--text-primary)]">No generated images yet</p>
            ...
            <div>
              {uploadHistory.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-lg font-medium mb-2 text-[var(--text-primary)]">No upload history</p>
            ...
            <div>
              {showCreateProject ? (
                <div className="max-w-md mx-auto py-8">
                  <h4 className="text-lg font-medium mb-4 text-[var(--text-primary)]">Create New Project</h4>
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-lg px-4 py-3 text-sm outline-none focus:border-purple-500 text-[var(--text-primary)]"
                        autoFocus
                      />
                    </div>
                    <div>
                      ...
                      <div className="flex gap-2">
                        {PROJECT_COLORS.map(color => (
                          <button
                            ...
                            className={`w-8 h-8 rounded-lg transition-all ${newProjectColor === color ? 'ring-2 ring-white ring-offset-2 ring-offset-[var(--bg-secondary)]' : ''}`}
                    ...
                    <div className="flex gap-2 pt-4">
                      <button
                        ...
                        className="flex-1 py-2 bg-[var(--bg-tertiary)] hover:bg-[var(--card-hover)] rounded-lg text-sm transition-colors text-[var(--text-primary)]"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="flex-1 py-2 bg-purple-500 hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 text-white"
                      >
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-purple-500 hover:bg-purple-600 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5 text-white"
                    >
                  ...
                  {projects.length > 0 ? (
                    <div className="grid grid-cols-3 gap-4">
                      {projects.map((project) => (
                        ...
                        >
                          ...
                          <p className="font-medium truncate text-[var(--text-primary)]">{project.name}</p>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-lg font-medium mb-2 text-[var(--text-primary)]">No projects yet</p>
                      <p className="text-[var(--text-muted)] mb-4">Create a project to save and organize your assets</p>
                      <button 
                        onClick={() => setShowCreateProject(true)}
                        className="px-6 py-2 bg-purple-500 hover:bg-purple-600 rounded-lg font-medium transition-colors text-white"
                      >
                        Create Project
                      </button>
                    </div>
