...
export function ConversationSidebar({ 
  ...
  const groupConversations = (convos: Conversation[]) => {
    ...
    const groups: { today: Conversation[]; yesterday: Conversation[]; lastWeek: Conversation[]; older: Conversation[] } = {
      today: [],
      yesterday: [],
      lastWeek: [],
      older: []
      ...
      {editingId === conv.id ? (
        <div className="flex items-center gap-1 px-3 py-2">
          <input
            ...
            className="flex-1 bg-[var(--bg-tertiary)] px-2 py-1 rounded text-sm outline-none border border-cyan-500/50 text-[var(--text-primary)]"
            autoFocus
          />
