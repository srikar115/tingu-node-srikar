...
export function ValuePropSection({ onGetStarted }: ValuePropSectionProps) {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-[var(--text-secondary)] mb-8 leading-relaxed">
              ...
              OmniHub gives you access to 50+ AI models for a fraction of the cost.
            </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-lg text-[var(--text-primary)]">OmniHub</span>
