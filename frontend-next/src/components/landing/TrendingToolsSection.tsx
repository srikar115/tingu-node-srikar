...
import { Image, Video, MessageSquare, Wand2, TrendingUp, Zap, ArrowUpRight, LucideIcon } from 'lucide-react';
...
interface TrendingTool {
  ...
  icon: LucideIcon;
  color: string;
  stats: { today: string; label: string };
  examples: string[];
}
...
export function TrendingToolsSection({ onToolClick }: TrendingToolsSectionProps) {
  return (
