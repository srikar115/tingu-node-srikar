...
const defaultFeaturedItems: FeaturedItem[] = [
  {
    ...
    mediaType: 'image',
    linkUrl: '/dashboard/generate?type=video',
    linkText: 'Try Now',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    mediaType: 'image',
    linkUrl: '/dashboard/generate?type=image',
    linkText: 'Create',
    featured: false,
  },
];
...
export function WhatsNewSection({ featuredItems = defaultFeaturedItems }: WhatsNewSectionProps) {
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h2 className="text-3xl font-bold text-[var(--text-primary)]">
              What's New @ <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">OmniHub</span>?
            </h2>
